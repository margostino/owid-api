...
func (r *queryResolver) CorporalPunishmentInSchoolsLongitudinalEvidenceFromEthiopiaIndiaPeruAndVietnamUnice(ctx context.Context, entity string, year int) (*model.CorporalPunishmentInSchoolsLongitudinalEvidenceFromEthiopiaIndiaPeruAndVietnamUniceDataset, error) {
	panic(fmt.Errorf("not implemented"))
}
...
func (r *queryResolver) CrudeBirthAndDeathRatesPer1_000EnglandAndWales1541_2015WrigleyAndSchofieldMitche(ctx context.Context, entity string, year int) (*model.CrudeBirthAndDeathRatesPer1000EnglandAndWales15412015WrigleyAndSchofieldMitcheDataset, error) {
	panic(fmt.Errorf("not implemented"))
}
...
func (r *queryResolver) DeathsFromChernobylRangeOfLongTermEstimatesWho2005FairlieAndSumner2006CardisE(ctx context.Context, entity string, year int) (*model.DeathsFromChernobylRangeOfLongTermEstimatesWho2005FairlieAndSumner2006CardisEDataset, error) {
	panic(fmt.Errorf("not implemented"))
}
...
func (r *queryResolver) EciCountryRankingsObservatoryOfEconomicComplexity2016AndTheAtlasOfEconomicComplexity(ctx context.Context, entity string, year int) (*model.EciCountryRankingsObservatoryOfEconomicComplexity2016AndTheAtlasOfEconomicComplexityDataset, error) {
	panic(fmt.Errorf("not implemented"))
}
...
func (r *queryResolver) GiniCoefficientEquivalizedIncomeAfterTaxAndTransfersChartbookOfEconomicInequality201(ctx context.Context, entity string, year int) (*model.GiniCoefficientEquivalizedIncomeAfterTaxAndTransfersChartbookOfEconomicInequality201Dataset, error) {
	panic(fmt.Errorf("not implemented"))
}
...
func (r *queryResolver) GlobalizationOver5CenturiesPwt90KlasingAndMilionis2014AndEstevadeordalFrantzAnd(ctx context.Context, entity string, year int) (*model.GlobalizationOver5CenturiesPwt90KlasingAndMilionis2014AndEstevadeordalFrantzAndDataset, error) {
	panic(fmt.Errorf("not implemented"))
}
...
func (r *queryResolver) IncidenceOfManagerialOrProfessionalJobsAndCollectiveBargainingByGenderBlauAndKahn20(ctx context.Context, entity string, year int) (*model.IncidenceOfManagerialOrProfessionalJobsAndCollectiveBargainingByGenderBlauAndKahn20Dataset, error) {
	panic(fmt.Errorf("not implemented"))
}
...
func (r *queryResolver) IncomesAcrossTheDistributionDatabaseAuthoredByNolanThewissenRoserBasedOnLisIndexed(ctx context.Context, entity string, year int) (*model.IncomesAcrossTheDistributionDatabaseAuthoredByNolanThewissenRoserBasedOnLisIndexedDataset, error) {
	panic(fmt.Errorf("not implemented"))
}
...
func (r *queryResolver) LabGrownMeatPricesNextbigfuture2017AndUnitedStatesBureauOfLaborStatisticsBls201(ctx context.Context, entity string, year int) (*model.LabGrownMeatPricesNextbigfuture2017AndUnitedStatesBureauOfLaborStatisticsBls201Dataset, error) {
	panic(fmt.Errorf("not implemented"))
}

func (r *queryResolver) LaborForceParticipationRatesOfMenAge65AndOverInTheUsOwidBasedOnShort2002AndOe(ctx context.Context, entity string, year int) (*model.LaborForceParticipationRatesOfMenAge65AndOverInTheUsOwidBasedOnShort2002AndOeDataset, error) {
	panic(fmt.Errorf("not implemented"))
}
...
func (r *queryResolver) LifeExpectancyAtAge10_1750_2100UnitedNationsPopulationDivisionAndHumanMortalityDataba(ctx context.Context, entity string, year int) (*model.LifeExpectancyAtAge1017502100UnitedNationsPopulationDivisionAndHumanMortalityDatabaDataset, error) {
	panic(fmt.Errorf("not implemented"))
}
...
func (r *queryResolver) LifeExpectancyJamesRileyForData1990AndEarlierWhoAndWorldBankForLaterDataByMaxR(ctx context.Context, entity string, year int) (*model.LifeExpectancyJamesRileyForData1990AndEarlierWhoAndWorldBankForLaterDataByMaxRDataset, error) {
	panic(fmt.Errorf("not implemented"))
}
...
func (r *queryResolver) LifeExpectationBySexAtAges0_15And45OwidBasedOnHacker2010AndTheUsSocialSecuri(ctx context.Context, entity string, year int) (*model.LifeExpectationBySexAtAges015And45OwidBasedOnHacker2010AndTheUsSocialSecuriDataset, error) {
	panic(fmt.Errorf("not implemented"))
}
...
func (r *queryResolver) NeglectedTropicalDiseasesLymphaticFilariasisPopulationRequiringPcNotTreatedAndTreated(ctx context.Context, entity string, year int) (*model.NeglectedTropicalDiseasesLymphaticFilariasisPopulationRequiringPcNotTreatedAndTreatedDataset, error) {
	panic(fmt.Errorf("not implemented"))
}
...
func (r *queryResolver) PercentageOfPersonsWithoutHealthInsuranceCouncilOfEconomicAdvisersAndNationalCenterFo(ctx context.Context, entity string, year int) (*model.PercentageOfPersonsWithoutHealthInsuranceCouncilOfEconomicAdvisersAndNationalCenterFoDataset, error) {
	panic(fmt.Errorf("not implemented"))
}
...
func (r *queryResolver) PopulationGrowthRateByRegion2020_2100MediumVariantProjectionUnPopulationDivision2015(ctx context.Context, entity string, year int) (*model.PopulationGrowthRateByRegion20202100MediumVariantProjectionUnPopulationDivision2015Dataset, error) {
	panic(fmt.Errorf("not implemented"))
}
...
func (r *queryResolver) PovertyRate50percOfMedianLisKeyFigures2018(ctx context.Context, entity string, year int) (*model.PovertyRate50percOfMedianLisKeyFigures2018Dataset, error) {
	panic(fmt.Errorf("not implemented"))
}
...
func (r *queryResolver) ProjectedChangeInUnder5PopulationByCountry2015_2050_2100OwidBasedOnUnPopulation20(ctx context.Context, entity string, year int) (*model.ProjectedChangeInUnder5PopulationByCountry201520502100OwidBasedOnUnPopulation20Dataset, error) {
	panic(fmt.Errorf("not implemented"))
}

func (r *queryResolver) ProjectedExtremePovertyAmongDifferentGroupingsOfFragileStatesCrespoCuaresmaEtAl2018(ctx context.Context, entity string, year int) (*model.ProjectedExtremePovertyAmongDifferentGroupingsOfFragileStatesCrespoCuaresmaEtAl2018Dataset, error) {
	panic(fmt.Errorf("not implemented"))
}
...
func (r *queryResolver) RegimePopulationsOwidBasedOnLuhrmannEtAl2018VDemV12Owid2021GapminderV6(ctx context.Context, entity string, year int) (*model.RegimePopulationsOwidBasedOnLuhrmannEtAl2018VDemV12Owid2021GapminderV6Dataset, error) {
	panic(fmt.Errorf("not implemented"))
}

func (r *queryResolver) RelativeEarningsOfAdultsByEducationalAttainmentEducationAtAGlance2017OecdIndicators(ctx context.Context, entity string, year int) (*model.RelativeEarningsOfAdultsByEducationalAttainmentEducationAtAGlance2017OecdIndicatorsDataset, error) {
	panic(fmt.Errorf("not implemented"))
}
...
func (r *queryResolver) ShareOfPeopleExperiencingHomelessnessInTheUsa2007_2016Per100_000Hud2016AndUsC(ctx context.Context, entity string, year int) (*model.ShareOfPeopleExperiencingHomelessnessInTheUsa20072016Per100000Hud2016AndUsCDataset, error) {
	panic(fmt.Errorf("not implemented"))
}
...
func (r *queryResolver) SplitOfExportsToDifferentCountryGroupsOwidCalculationsBasedOnFouquinAndHugotCepii2(ctx context.Context, entity string, year int) (*model.SplitOfExportsToDifferentCountryGroupsOwidCalculationsBasedOnFouquinAndHugotCepii2Dataset, error) {
	panic(fmt.Errorf("not implemented"))
}
...
func (r *queryResolver) TetanusNeonatalRateCalculatedFromWhoIncidence2017AndWdiPopulationDataHannahBehren(ctx context.Context, entity string, year int) (*model.TetanusNeonatalRateCalculatedFromWhoIncidence2017AndWdiPopulationDataHannahBehrenDataset, error) {
	panic(fmt.Errorf("not implemented"))
}
...
func (r *queryResolver) TotalFertilityByRegion2020_2100MediumVariantProjectionUnPopulationDivision2015Revisi(ctx context.Context, entity string, year int) (*model.TotalFertilityByRegion20202100MediumVariantProjectionUnPopulationDivision2015RevisiDataset, error) {
	panic(fmt.Errorf("not implemented"))
}
...
func (r *queryResolver) TotalValueOfExportsByCountryToWorldPercgdpOwidCalculationsBasedOnFouquinAndHugotCep(ctx context.Context, entity string, year int) (*model.TotalValueOfExportsByCountryToWorldPercgdpOwidCalculationsBasedOnFouquinAndHugotCepDataset, error) {
	panic(fmt.Errorf("not implemented"))
}
...
func (r *queryResolver) TradeShareWithCapitalAndLaborIntensiveCountriesOwidCalculationsBasedOnFouquinAndHugo(ctx context.Context, entity string, year int) (*model.TradeShareWithCapitalAndLaborIntensiveCountriesOwidCalculationsBasedOnFouquinAndHugoDataset, error) {
	panic(fmt.Errorf("not implemented"))
}
...
func (r *queryResolver) UkNominalWageDataPriceDataAndRealWageBankOfEnglandThreeCenturiesOfMacroeconomic(ctx context.Context, entity string, year int) (*model.UkNominalWageDataPriceDataAndRealWageBankOfEnglandThreeCenturiesOfMacroeconomicDataset, error) {
	panic(fmt.Errorf("not implemented"))
}
...
func (r *queryResolver) UsaPolioCasesAndDeaths1910_2010OwidBasedOnUsPublicHealthService1910_1951UsCenter(ctx context.Context, entity string, year int) (*model.UsaPolioCasesAndDeaths19102010OwidBasedOnUsPublicHealthService19101951UsCenterDataset, error) {
	panic(fmt.Errorf("not implemented"))
}
...
func (r *queryResolver) ViolentDeathsInConflictsAndOneSidedViolenceSince1989ByRegionAndTypeOfViolenceUcdp(ctx context.Context, entity string, year int) (*model.ViolentDeathsInConflictsAndOneSidedViolenceSince1989ByRegionAndTypeOfViolenceUcdpDataset, error) {
	panic(fmt.Errorf("not implemented"))
}
...
func (r *queryResolver) WagesInTheManufacturingSectorVsSeveralFoodPricesInTheUsUsBureauOfLaborStatistic(ctx context.Context, entity string, year int) (*model.WagesInTheManufacturingSectorVsSeveralFoodPricesInTheUsUsBureauOfLaborStatisticDataset, error) {
	panic(fmt.Errorf("not implemented"))
}
